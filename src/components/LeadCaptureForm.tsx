...
/**
 * Props for the LeadCaptureForm component.
 * @interface LeadCaptureFormProps
 */
interface LeadCaptureFormProps {
  /** Callback function invoked when the user submits the form to start the chat. */
  onStartChat: (details: { name: string; contactMethod: ContactMethod; contactInfo: string }) => void;
  /** Boolean indicating if the form is currently in a loading state (e.g., connecting to chat). */
  isLoading: boolean;
  /** Localized title for the form. */
  title: string;
  /** Localized subtitle for the form. */
  subtitle: string;
  /** Localized placeholder text for the name input field. */
  namePlaceholder: string;
  /** Localized prompt for selecting a contact method. */
  contactPrompt: string;
  /** Object mapping contact methods to their localized placeholder texts. */
  contactPlaceholders: { [key in ContactMethod]: string };
  /** Localized text for the primary submit button. */
  buttonText: string;
  /** Localized text for the submit button when in a loading state. */
  connectingText: string;
  /** Localized text for the button to change the selected contact method. */
  changeButtonText: string;
  /** Object mapping error keys to their localized error messages. */
  errorMessages: { [key: string]: string };
}

/**
 * Array defining the available contact method options.
 * Each option includes an ID, display name, icon class (from Bootstrap Icons), and a hex color code.
 */
 ...
 * Displays a form for users to enter their name and preferred contact method
